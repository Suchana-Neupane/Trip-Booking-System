     ...
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <textarea class="form-control"  name="guides_id" placeholder="Guides_id"></textarea>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Vehicles_id:</strong>
                <textarea class="form-control"  name="vehicles_id" placeholder="Vechicles_id"></textarea>
            </div>
        </div>
